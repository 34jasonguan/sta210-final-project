...
```
The confusion matrix above shows us all of the true/false positives and negatives. From this, we find that we have a sensitivity of 0.587628865979, a specificity of 0.97, a positive predicted value of 0.730769230769, and a negative predicted value of 0.944367176634. Overall, this means that the model is better at making negative predictions than positive predictions, with a higher specificity and NPV and a lower sensitivity and PPV. 
